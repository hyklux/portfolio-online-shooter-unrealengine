...
#include "MultiplayerFPSGame/FPSTypes/TurningInPlace.h"
#include "MultiplayerFPSGame/Interfaces/InteractWithCrosshairsInterface.h"
...
UCLASS()
class MULTIPLAYERFPSGAME_API AFPSCharacter : public ACharacter, public IInteractWithCrosshairsInterface
{
	GENERATED_BODY()
