...
#include "MultiplayerFPSGame/Character/FPSAnimInstance.h"
#include "MultiplayerFPSGame/Weapon/Projectile.h"
#include "MultiplayerFPSGame/Weapon/Shotgun.h"
...
void UCombatComponent::TraceUnderCrosshairs(FHitResult& TraceHitResult)
{
	...
	if (bScreenToWorld)
	{
		...
		if (IsValid(TraceHitResult.GetActor()) && TraceHitResult.GetActor()->Implements<UInteractWithCrosshairsInterface>())
		{
